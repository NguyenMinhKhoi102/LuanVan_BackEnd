...
//        System.out.println(role);
        ...
        case "admin":
          ...
          break;
        case "province":
          Role provinceRole = roleRepository.findByName(ERole.ROLE_PROVINCE)
              .orElseThrow(() -> new RuntimeException("Error: Role is not found."));
          roles.add(provinceRole);

          break;
          case "district":
            Role districtRole = roleRepository.findByName(ERole.ROLE_DISTRICT)
                    .orElseThrow(() -> new RuntimeException("Error: Role is not found."));
            roles.add(districtRole);

            break;
          case "ward":
            Role wardRole = roleRepository.findByName(ERole.ROLE_WARD)
                    .orElseThrow(() -> new RuntimeException("Error: Role is not found."));
            roles.add(wardRole);
